...
<body>
	...
	<form name="search" method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
      ...
      $pCapital;
		...
		// Loop through each row of data and remove the row with the ID to delete
		...
		// Write the updated array of data back to the CSV file
		if (($handle = fopen($portfolioFile, 'w')) !== false) {
